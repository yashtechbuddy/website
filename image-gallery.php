        ...
        <div class="row">
            <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div align="center" class="portfolio_menu tabs">
                    <ul class="row list-unstyled justify-content-center">
                        <li><a class="btn filter-button" data-filter="all">All</a></li>
                        <?php
         ...
         ?>
                ...
                <?php
                        ...
                        ?>           
                <div class="gallery_product photo col-lg-3 col-md-6 col-sm-3 col-xs-4 filter <?php echo $image['category_id']; ?> html5lightbox" >
                    <a href="admin/images/gallery/<?php echo $image['gallery_image']; ?>" class="popup-gallery-item">
                        <img  src="admin/images/gallery/<?php echo $image['gallery_image']; ?>"
                         width="280" height="70">
                    </a>
                </div>
                <?php 
