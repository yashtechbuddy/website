          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav__item has-dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav__item">
                    <a href="departments.php" class="nav__item-link">Departments </a>
                  </li><!-- /.nav-item -->
                  <li class="nav__item">
                    <a href="departments-single.php" class="nav__item-link">Departments Single</a>
                  </li><!-- /.nav-item -->
                </ul><!-- /.dropdown-menu -->
              </li><!-- /.nav-item -->
              <li class="nav__item has-dropdown">
            ...
            <div class="feature-item feature-item-custom">
              <div class="feature__content">
                ...
                <p class="feature__desc">Qualified doctors available six days a week, view timetable to make an
                  appointment.</p>
                <a href="doctors-timetable.php" class="btn btn__white btn__link">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-5">
            <div class="about__text">
              ...
              <a href="doctors-timetable.php" class="btn btn__secondary btn__rounded mt-40">
        ...
        <div class="row heading-layout2">
          ...
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-1">
            ...
            <div class="d-flex flex-wrap align-items-center mt-30 mb-60">
              ...
              <a href="doctors-modern.php" class="btn btn__secondary btn__link">
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="service-item">
              ...
              <div class="service__content">
                ...
                <a href="departments-single.php" class="btn btn__secondary btn__outlined btn__rounded">
                  <span>Read More</span>
                  <i class="icon-arrow-right"></i>
                </a>
          ...
          <div class="col-sm-12 col-md-12 col-lg-6">
            <div class="banner-text">
              ...
              <div class="d-flex flex-wrap">
                <a href="doctors-timetable.php" class="btn btn__white btn__rounded mr-30">
                  <span>Find A Doctor</span> <i class="icon-arrow-right"></i>
                </a>
...
<!-- Mirrored from 7oroof.com/demos/medcity/home-classic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 31 Jul 2023 05:22:46 GMT -->
</html>