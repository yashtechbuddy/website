<?php 
	...
	require("language/language.php");
     ...
     $qry="SELECT * FROM tbl_courses order by position_order ASC";
     $result=mysqli_query($mysqli,$qry); 	
	 	
	if(isset($_GET['delete_id']))
	{
 
		$cat_res=mysqli_query($mysqli,'SELECT * FROM tbl_courses WHERE id='.$_GET['delete_id'].'');
		$cat_res_row=mysqli_fetch_assoc($cat_res);


		if($cat_res_row['image']!="")
	    {
	    	unlink('images/courses/'.$cat_res_row['image']);
		}
 
		if($cat_res_row['page_name']!="")
	    {
	    	unlink('../courses/'.$cat_res_row['page_name']);
		}

		Delete('tbl_courses','id='.$_GET['delete_id'].'');
...
<div class="breadcrumbbar">
   <div class="row align-items-center">
	  ...
	  <div class="col-md-4 col-lg-4">
                        <div class="widgetbar">
							<a href="add_courses.php?add=yes" >
						   <button class="btn btn-primary"><i class="feather icon-plus mr-2"></i>Add courses</button>	
						   </a>
                        </div>                        
                    </div>
   </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>
			...
			<div class="alert alert-danger alert-dismissible fade show" role="alert">
				<strong>This Course is already exist ! </strong>
					<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>              
			</div>  
         ...
         <div class="card m-b-30">
            <div class="card-body">
               <div class="table-responsive">
				...
				<td>
                <img height="70" width="70" style="object-fit:cover;" src="images/courses/<?php echo $row['icon'];?>" />
				</td>
				<td>
                <img height="70" width="70" style="object-fit:cover;" src="images/courses/<?php echo $row['image'];?>" />
				</td>
				  
                  <td>
				  <a href="add_courses.php?edit_id=<?php echo $row['id'];?>" class="btn btn-dark"><i class="feather ion ion-md-create"></i>  Edit</a>
