<?php 
	...
	require ("language/language.php");
     ...
     $qry="SELECT * FROM tbl_gallery order by id";
...
// 		}
		...
		$_SESSION['msg']="12";
		header( "Location:manage_gallery_image.php");
		exit;
...
<div class="breadcrumbbar">
   <div class="row align-items-center">
      <div class="col-md-8 col-lg-8">
         <h2 class="page-title">Manage Image</h2>
      </div>
	  <div class="col-md-4 col-lg-4">
                        <div class="widgetbar">
							<a href="add_image.php?add=yes" >
						   <button class="btn btn-primary"><i class="feather icon-plus mr-2"></i>Add Image</button>	
						   </a>
                        </div>                        
                    </div>
               ...
               <div class="table-responsive">
				...
				<tr id="<?php echo $row['id']; ?>">                 
                 <td><?php echo $i+1; ?></td>
                  ...
                  <td>
					<?php if($row['image']!=""){?>
						<img height="70" width="auto" style="object-fit:cover;" src="images/gallery/<?php echo $row['image'];?>" />
				    <?php }else{ ?><img height="50" width="50" style="object-fit:cover;" src="images/add-image.png" />
					<?php } ?>
				  </td>
				  <a href="add_image.php?edit_id=<?php echo $row['id'];?>" class="btn btn-dark"><i class="feather ion ion-md-create"></i> Edit</a>
