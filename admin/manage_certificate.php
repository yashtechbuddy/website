<?php 
	...
	require ("language/language.php");
     ...
     $qry="SELECT * FROM tbl_certificate order by position_order ASC";
	...
	if(isset($_GET['delete_id']))
	{
		...
		$cat_res=mysqli_query($mysqli,'SELECT * FROM tbl_certificate WHERE id='.$_GET['delete_id'].'');
		$cat_res_row=mysqli_fetch_assoc($cat_res);

		if($cat_res_row['image']!="")
	    {
	    	unlink('images/certificate/'.$cat_res_row['image']);
		}
 
		Delete('tbl_certificate','id='.$_GET['delete_id'].'');
...
<div class="breadcrumbbar">
   <div class="row align-items-center">
      <div class="col-md-8 col-lg-8">
         <h2 class="page-title">Manage Certificate</h2>
      </div>
	  <div class="col-md-4 col-lg-4">
         <div class="widgetbar">
				<a href="add_certificate.php?add=yes" >
               ...
               <div class="table-responsive">
				...
				<tr id="<?php echo $row['id']; ?>">                 
                 <td><?php echo $row['position_order'];?></td>
                  <td>
					<?php if($row['image']!=""){?>
						<img height="70" width="auto" style="object-fit:cover;" src="images/certificate/<?php echo $row['image'];?>" />
				    <?php }else{ ?><img height="50" width="50" style="object-fit:cover;" src="images/add-image.png" />
					<?php } ?>
				  </td>
				
                  <td>
				  <a href="add_certificate.php?edit_id=<?php echo $row['id'];?>" class="btn btn-dark"><i class="feather ion ion-md-create"></i>  Edit</a>
...
<script type="text/javascript">
					$( ".row_position" ).sortable({
						delay: 150,
						stop: function() {
							var DatabaseName = 'tbl_certificate';
