<?php 
	...
	require ("language/language.php");
     ...
     $qry="SELECT * FROM tbl_gallery_category ORDER BY position_order";
	...
	if(isset($_GET['delete_id']))
	{
		...
		$cat_res=mysqli_query($mysqli,'SELECT * FROM tbl_gallery_category WHERE id='.$_GET['delete_id'].'');
		$cat_res_row=mysqli_fetch_assoc($cat_res);

	
 
		Delete('tbl_gallery_category','id='.$_GET['delete_id'].'');
...
<div class="breadcrumbbar">
   <div class="row align-items-center">
      <div class="col-md-8 col-lg-8">
         <h2 class="page-title">Manage Gallery Category</h2>
      </div>
	  <div class="col-md-4 col-lg-4">
                        <div class="widgetbar">
							<a href="add_gallery_category.php?add=yes" >
            ...
            <div class="card-body">
               <div class="table-responsive">
				...
				<tr id="<?php echo $row['id']; ?>">
                  ...
                  <td>
				  <a href="add_gallery_category.php?edit_id=<?php echo $row['id'];?>" class="btn btn-dark"><i class="feather ion ion-md-create"></i>Edit</a>
...
<script type="text/javascript">
					$( ".row_position" ).sortable({
						delay: 150,
						stop: function() {
							var DatabaseName = 'tbl_gallery_category';
