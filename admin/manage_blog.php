<?php 
	...
	require ("language/language.php");
     ...
     $qry="SELECT * FROM tbl_blog order by id ";
	...
	if(isset($_GET['delete_id']))
	{
		...
		$cat_res=mysqli_query($mysqli,'SELECT * FROM tbl_blog WHERE id='.$_GET['delete_id'].'');
		$cat_res_row=mysqli_fetch_assoc($cat_res);


		if($cat_res_row['image']!="")
	    {
	    	unlink('images/blog/'.$cat_res_row['image']);
		}

		if($cat_res_row['page_name']!="")
	    {
	    	unlink('../blog/'.$cat_res_row['page_name']);
		}
 
		Delete('tbl_blog','id='.$_GET['delete_id'].'');
...
<div class="breadcrumbbar">
   <div class="row align-items-center">
      <div class="col-md-8 col-lg-8">
         <h2 class="page-title">Manage Blog</h2>
      </div>
	  <div class="col-md-4 col-lg-4">
                        <div class="widgetbar">
							<a href="add_blog.php?add=yes" >
						   <button class="btn btn-primary"><i class="feather icon-plus mr-2"></i>Add Blog</button>	
						   </a>
                        </div>                        
                    </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>
  <?php if(isset($_SESSION['msg'])){?>
			...
			<div class="alert alert-danger alert-dismissible fade show" role="alert">
				<strong>This Blog is already exist ! </strong>
					<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>              
			</div>  
               ...
               <div class="table-responsive">
                ...
                <tr id="<?php echo $row['id']; ?>">                 
                 <td><?php echo $row['position_order'];?></td>
                  ...
                  <td>
				  <a href="add_blog.php?edit_id=<?php echo $row['id'];?>" class="btn btn-dark"><i class="feather ion ion-md-create"></i>  Edit</a>
